...
def test_paper_mode_pins_sandbox(trading_cls, _data):
...
@patch("src.alpaca_client.StockHistoricalDataClient")
@patch("src.alpaca_client.TradingClient")
def test_live_mode_uses_live_endpoint(trading_cls, _data):
    from src.alpaca_client import AlpacaClient
...
@patch("src.alpaca_client.StockHistoricalDataClient")
@patch("src.alpaca_client.TradingClient")
def test_submit_order_delegates(trading_cls, _data):
    from src.alpaca_client import AlpacaClient
